...
# URL Configuration
# urlpatterns = [
#     # Swagger UI view with Basic Auth protection
#     path('api/schema/swagger-ui/', swagger_auth_required(SpectacularSwaggerView.as_view()), name='swagger-ui'),
# ]
...
# # from drf_spectacular.generators import OpenAPISchemaGenerator
