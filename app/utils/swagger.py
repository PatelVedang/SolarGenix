...
def apply_swagger_tags(**kwargs):
    ...
    detailed_methods = kwargs.get("detailed_methods", ["create", "retrieve", "list", "partial_update", "destroy"])
        ...
        for method, obj in methods.items():
            if hasattr(view, method):
                if method in extra_actions:
                    ...
                    setattr(view, method, wraps(view_method)(
                        swagger_auto_schema(
                            tags=tags,
                    ...
                    view_method = getattr(view, method)
                    setattr(view, method, method_decorator(
                        name=method,
