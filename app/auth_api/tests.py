...
class AuthTest(BaseAPITestCase):
    ...
    #     checks for an error response.
    #     """
    #     self.register(password="Test@12")
    #     self.match_error_response(400)
    ...
    #     checks for an error response.
    #     """
    #     self.register(password="testpassword")
    #     self.match_error_response(400)
    ...
    # def test_refersh_token_without_payload(self):
    #     """
    #     The function `test_refresh_token` logs in, extracts the refresh token, sends a POST request to
    #     refresh the token, and matches the success response.
    #     """
    ...
    #     """
    #     This function tests the get profile functionality with a blacklisted token.
    #     """
    #     self.login()
    #     self.make_token_blacklist(TokenType.ACCESS.value)
    #     self.set_response(self.client.get(self.profile_url, format="json"))
    ...
    #     self.set_response(
    #         self.client.post(
    #             f"{self.prefix}/forgot-password", data={}, format="json"
    #         )
    #     )
    #     self.match_error_response(400)
    ...
    #     """
    #     self.send_verification_email()
    #     verify_token = SimpleToken.for_user(self.super_admin, TokenType.VERIFY_MAIL.value, 1)
    #     self.set_response(
    #         self.client.get(f"{self.prefix}/verify-email/{verify_token}")
    #     )
    #     self.match_success_response(204)
