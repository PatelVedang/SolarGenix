...
urlpatterns = [
    ...
    path('auth/change-password/',ChangePassowordView.as_view(),name="change-password-email"),
    ...
    path('auth/resend-verify-token', ResendVerifyTokenView.as_view(), name='resend-verify-token'),
