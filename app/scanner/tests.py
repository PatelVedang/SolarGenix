...
from scanner.models import Target, Tool, Order
...
class ExceptionHandlerTest(BaseAPITestCase):
    ...
    def test_unauthorize(self):
        ...
        """
        self.set_response(self.client.get(f"{self.prefix}orders/"))
    ...
    def test_invalid_token(self):
        ...
        self.set_response(self.client.get(f"{self.prefix}orders/", format="json"))
        self.match_error_response()
    ...
    def test_not_found_error(self):
        ...
        """
        self.login()
        self.set_response(self.client.get(f"{self.prefix}orders/0/", format="json"))
        self.match_error_response()
...
class BatchScanTest(BaseAPITestCase):
    prefix = "/api/"
    ...
    def test_add_by_ids_api(self):
        ...
        self._data = {"orders_id": [obj.id]}
        self.set_response(
            self.client.post(
                f"{self.prefix}orders/addByIds/", data=self._data, format="json"
            )
        )
        self.match_success_response()
    ...
    def test_retrieve_api(self):
        ...
        obj = Order.objects.first()
        self.set_response(
            self.client.get(f"{self.prefix}orders/{obj.id}/", format="json")
        )
        self.match_success_response()
...
class ToolTest(BaseAPITestCase):
    ...
    def test_update_api(self):
        ...
        self.set_response(
            self.client.patch(
                f"{self.prefix}tool/{obj.id}/", data=self._data, format="json"
            )
        )
        self.match_success_response()
    ...
    def test_retrieve_api(self):
        ...
        obj = Tool.objects.first()
        self.set_response(
            self.client.get(f"{self.prefix}tool/{obj.id}/", format="json")
        )
        self.match_success_response()
    ...
    def test_delete_api(self):
        ...
        obj = Tool.objects.first()
        self.set_response(
            self.client.delete(f"{self.prefix}tool/{obj.id}/", format="json")
        )
        self.match_success_response()


class TargetsScanTest(BaseAPITestCase):
    prefix = "/api/"
    ...
    def test_list_api(self):
        ...
        self.login()
        self.insert_order()
        self.set_response(self.client.get(f"{self.prefix}targets/", format="json"))
        self.match_success_response()
    ...
    def test_add_by_ids_api(self):
        ...
        self._data = {"targets_id": [obj.id]}
        self.set_response(
            self.client.post(
                f"{self.prefix}targets/addByIds/", data=self._data, format="json"
            )
        )
        self.match_success_response()
    ...
    def test_retrieve_api(self):
        ...
        obj = Target.objects.first()
        self.set_response(
            self.client.get(f"{self.prefix}targets/{obj.id}/", format="json")
        )
        self.match_success_response()